...
tokeniser = LayoutLMv3TokenizerFast.from_pretrained("D:/Python/visual-ocr-label/inputs/layoutlmv3Microsoft",ignore_mismatched_sizes=True)

processor = LayoutLMv3Processor(tokenizer=tokeniser,feature_extractor=featur_extractor)
model = LayoutLMv3ForTokenClassification.from_pretrained('D:/Python/visual-ocr-label/inputs/layoutlmv3Microsoft')


if __name__ == "__main__":
    ds = dataSet('D:/Python/visual-ocr-label/inputs/Training_layoutLMV31.json',processor)
